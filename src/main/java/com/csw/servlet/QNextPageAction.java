...
public class QNextPageAction extends HttpServlet {
    @Override
    public void service(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("\nQNextPageAction-currPage=" + currPage);
        System.out.println("\nQNextPageAction-productname=" + productName + "\nQNextPageAction-price=" + price + "\nQNextPageAction-opt=" + opt);
        ProductService ps = new ProductServiceImpl();
        List<Product> list = ps.queryPersonByArrayLike(currPage, 3,
                productName, price, opt, countPage);

        System.out.println("\nQNextPageAction-list=" + list);
