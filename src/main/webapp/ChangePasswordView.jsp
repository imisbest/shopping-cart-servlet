...
<form method="post" action="${path}/a/ChangePasswordAction">
    <table cellpadding=3 cellspacing=1 align=center class=tableborder1>
        ...
        <tr>
            ...
            <td valign="middle" class="tablebody1"><input name="oldPass"
                                                          type="text"/></td>
        </tr>
        <tr>
            <td valign="middle" class="tablebody1">请输入您的新密码</td>
            <td valign="middle" class="tablebody1"><input name="newPass1"
                                                          type="password"> &nbsp;
            </td>
        </tr>
        <tr>
            <td valign="middle" class="tablebody1">请再次输入您的新密码</td>
            <td valign="middle" class="tablebody1"><input name="newPass2"
                                                          type="password"> &nbsp;
            </td>
        </tr>
        <tr>
